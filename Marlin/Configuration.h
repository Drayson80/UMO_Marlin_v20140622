...
#define VERSION_PROFILE "Drayson Dev_48.1"
...
*/
// If you want to enable this feature for all your extruder heaters, uncomment the defines below:
...
//#define FILAMENT_RUNOUT_SENSOR // Uncomment for defining a filament runout sensor such as a mechanical or opto endstop to check the existence of filament
  ...
  const bool FIL_RUNOUT_INVERTING = true;  // true or false should assigned
...
#define TOOLHEAD_SUPPORT  //Uncomment to enable toolhead support such for el-cheapo laser, drag knife and similar ones
#define TOOLHEAD_OFFSET_VALUE 180 // Offset value
...
#define LCD_FEEDBACK_FREQUENCY_HZ 166.66	// this is the tone frequency the buzzer plays when on UI feedback. ie Screen Click
#define LCD_FEEDBACK_FREQUENCY_DURATION_MS 110 // the duration the buzzer plays the UI feedback sound. ie Screen Click
