...
// Languages
// en  English
// de  German => not updated!!! just en to be used!!!
...
// Please note these are limited to 17 characters!
	...
	#define MSG_LOAD_ROUTINE "Insert material..."
	#define MSG_UNLOAD_ROUTINE "Remove material..."
	#define MSG_LOAD_PLA "Load PLA"
	#define MSG_LOAD_PLA0 "Load PLA 1"
	#define MSG_LOAD_PLA1 "Load PLA 2"
	#define MSG_LOAD_PLA2 "Load PLA 3"
	#define MSG_LOAD_ABS "Load ABS"	
	#define MSG_LOAD_ABS0 "Load ABS 1"
	#define MSG_LOAD_ABS1 "Load ABS 2"
	#define MSG_LOAD_ABS2 "Load ABS 3"
	#define MSG_UNLOAD_PLA "Unload PLA"
	#define MSG_UNLOAD_PLA0 "Unload PLA 1"
	#define MSG_UNLOAD_PLA1 "Unload PLA 2"
	#define MSG_UNLOAD_PLA2 "Unload PLA 3"
	#define MSG_UNLOAD_ABS "Unload ABS"	
	#define MSG_UNLOAD_ABS0 "Unload ABS 1"
	#define MSG_UNLOAD_ABS1 "Unload ABS 2"
	#define MSG_UNLOAD_ABS2 "Unload ABS 3"
